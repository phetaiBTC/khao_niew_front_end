    ...
    <a-modal v-model:open="localOpen" :footer="null" @ok="onClose" @cancel="onClose" :width="'400px'" centered>
                ...
                <a-col :span="24">
                    <div class="w-full overflow-x-scroll my-5">
                         <div class="flex flex-nowrap gap-3 flex-row">
                            <div v-for="image in props.data?.images" :key="image.id"  class="relative flex-shrink-0 w-[120px] h-[120px] rounded-lg overflow-hidden">
                            <div class="relative">
                              <a-image
        :src="image.url"
        :preview="true"
      ...
      />
                              <a-button
                                ...
                                danger
                                size="small"
                                class="absolute top-1 right-1 bg-red-500 hover:bg-red-600 text-white rounded-full w-5 h-5 flex items-center justify-center shadow-md"
