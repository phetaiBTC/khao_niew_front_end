<template>
  ...
  <div class="flex flex-nowrap gap-3 flex-row">
    <div
      ...
      :key="image.id"
      class="relative flex-shrink-0 w-[120px] h-[120px] rounded-lg overflow-hidden"
    >
      <!-- The image -->
      <a-image
        :src="image.url"
      ...
      <button
        ...
        class="absolute top-1 right-1 bg-red-500 hover:bg-red-600 text-white rounded-full w-5 h-5 flex items-center justify-center shadow-md z-10"
      >
