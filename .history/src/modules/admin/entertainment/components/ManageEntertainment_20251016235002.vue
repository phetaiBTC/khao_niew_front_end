<template>
  ...
  >
    <template #title>
      <h1 class="text-xl text-center" style="font-weight: 900">
        {{ $t("add") + " " + $t("entertainment") }}
      </h1>
    </template>
    <a-form
      layout="vertical"
    ...
    >
      <a-row>
        ...
        <a-col :span="24">
          ...
          >
            <a-button> <UploadOutlined /> เลือกไฟล์ </a-button>
          </a-upload>
        </a-col>
        <a-col :span="24">
...
const { createEntertainment, updateEntertainment, loadingEntertainment } =
  useEntertainment();
const formRef = ref();
